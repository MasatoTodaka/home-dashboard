...
*朝モード (毎朝 6:00〜7:30): 今日の天気とバイクで出かけられるか (アイコンの色)・1時間ごとの雨・今日のごみ出し・今日の予定*
...
- **今日の天気とバイク判定**: 今日の天気・最高/最低気温と、7時・12時・18時の天気と気温、最大風速を表示。
  バイクで出かけられるかは、今日のこれから (7時〜21時) の1時間ごとの予報 (雨・突風・凍結・猛暑) から判定し、
  バイクのアイコンの色 (緑: 行ける / 黄: 注意 / 赤: やめておこう) で示す
